...
public class CircleProgressBarView extends View {
    ...
    public CircleProgressBarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        radius = typedArray.getDimension(R.styleable.CircleProgressBarView_radius, DensityUtil.INSTANCE.dip2px(getContext(),15));
        ...
        playSignHeight = typedArray.getDimension(R.styleable.CircleProgressBarView_playSignHeight, DensityUtil.INSTANCE.dip2px(getContext(),12));
        playSignSpacing = typedArray.getDimension(R.styleable.CircleProgressBarView_playSignSpacing, DensityUtil.INSTANCE.dip2px(getContext(),6));
        pauseSignLength = typedArray.getDimension(R.styleable.CircleProgressBarView_pauseSignLength, DensityUtil.INSTANCE.dip2px(getContext(),8));
        pauseSignWidth = typedArray.getDimension(R.styleable.CircleProgressBarView_pauseSignWidth, DensityUtil.INSTANCE.dip2px(getContext(),10));
        initPaint();
    }
